...
# Another example with Deep Script Block Logging
$Code = Get-Content -Path C:\Scripts\Demo2\Malicious.txt -Raw
Add-Type -TypeDefinition $Code -Language CSharp
[CS.Malicious]::Payload()

# Inspect the deep script logging results
Get-WinEvent -LogName "Microsoft-Windows-PowerShell/Operational" |
Where-Object {$_.Message -match 'PayLoad'} | Select-Object -ExpandProperty Message